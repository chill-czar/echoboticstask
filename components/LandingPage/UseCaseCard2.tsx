...
import Card2 from "@/public/Images/Card2.png"; // rename your file to Card2.png and place it inside /public/Images

const UseCaseCard2 = () => {
  return (
    <div className="relative w-[370px] h-[624px]">
      {/* Main Card with gradient and blur */}
      <div
      ...
      >
        ...
        <div className="absolute left-[20px] top-[370px] w-[324px]">
          <h1 className="font-fontSpring text-[30px] leading-[36px] text-[#EC4E02]">
